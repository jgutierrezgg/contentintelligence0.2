    ...
    <>
      <div className={styles.phaseStack}>
        <PhaseHeader
          icon="🟢"
          title="Planning"
          subtitle="Schedule content briefs and assets into a weekly publishing calendar."
        />
          ...
          <>
            <div className={styles.viewToggleRow}>
              <button
                ...
                className={[styles.viewToggleBtn, view === 'list' ? styles.viewToggleBtnActive : ''].filter(Boolean).join(' ')}
              >
                List
              </button>
              <button
                onClick={() => setView('calendar')}
                className={[styles.viewToggleBtn, view === 'calendar' ? styles.viewToggleBtnActive : ''].filter(Boolean).join(' ')}
              >
                Calendar
              </button>
            </div>
            ...
            {view === 'list' ? (
              ...
              <div className={styles.calendarGrid}>
                {weeks.map(week => (
                  <div key={week} className={styles.calendarCol}>
                    <div className={styles.calendarColHead}>Week {week}</div>
                    <div className={styles.calendarColBody}>
                      {items.filter(i => i.week === week).map(item => (
                        <div
                          ...
                          className={[
                            styles.calendarCard,
                            item.id === selectedId ? styles.calendarCardSelected : '',
                          ].filter(Boolean).join(' ')}
                        >
                          ...
                          <div className={styles.calendarCardTitle}>{item.title}</div>
                        </div>
                      ))}
                    </div>
                  </div>
